      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="space-y-4 flex flex-col justify-start">
          ...
          <div className="flex gap-4 mt-4">
            <a href="https://www.instagram.com/askclera/" target="_blank" rel="noreferrer" aria-label="Instagram">
        ...
        {/* Right side */}
        <div className="space-y-4 md:text-right flex flex-col justify-start">
          <h3 className="text-white font-semibold">Contact Us</h3>
          <a href="mailto:support@askclera.com" className="block text-gray-400 hover:text-white transition-colors text-lg font-medium">
            support@askclera.com
          </a>
          <div className="pt-8 mt-8 flex flex-col md:flex-row gap-4 justify-between items-center md:items-end">
