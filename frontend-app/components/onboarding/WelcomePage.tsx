...
export default function WelcomePage({ onContinue }: WelcomePageProps) {
  return (
    <div className="flex flex-col justify-between min-h-[calc(100vh-12rem)] sm:min-h-[calc(100vh-16rem)]">
      <div className="flex flex-col items-center justify-center flex-1 px-4 pt-2 sm:pt-8 pb-8 sm:pb-16">
        <div className="max-w-2xl mx-auto space-y-4 sm:space-y-8 text-center">
          ...
          <p className="text-xl text-muted-foreground">
            I'll help you set up your brokerage account so we can start building your wealth.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 sm:mt-12">
