...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen w-full bg-black flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="container relative z-10 flex flex-col items-center justify-center w-full max-w-4xl mx-auto px-6 md:px-8 lg:px-10 py-8 gap-8 text-center">
        {/* SEC Badge with animated border */}
        <motion.div
        ...
        >
          <Button
            ...
            className="bg-black/80 text-gray-300 border-neutral-800 text-sm font-medium px-6"
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-7xl font-bold !leading-tight bg-gradient-to-r from-blue-400 via-blue-500 to-cyan-400 bg-clip-text text-transparent"
        >
          Meet Clera.
        </motion.h1>
        ...
        >
          ...
          <br />
          Get Wall Street-level guidance at a fraction of the cost.
        </motion.p>
        ...
        >
          ...
          <Link href="#comparison" className="flex-1">
