...
def _submit_snaptrade_market_order(user_id: str, account_id: str, ticker: str, notional_amount: float, action: str) -> str:
    ...
    try:
        ...
        # Check for market closed error (includes Webull's fractional share after-hours restriction)
        ...
        # Handle Webull minimum order amount for fractional shares ($5 minimum, code 1119)
        if '1119' in error_str or 'FRACT_AMOUNT_GREAT_5' in error_str or 'minimum order amount' in error_str.lower():
