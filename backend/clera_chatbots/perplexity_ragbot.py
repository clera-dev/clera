...
# using `python3 perplexity_ragbot.py` (assuming you're cd'ed into clera_chatbots directory)
#
# 
# With initial functionality built out in "test_pincone_rag.py" and "retrieving_from_pineocone.py,"
# this file will integrate LangGraph memory to allow the RAG bot to reference previous inputs.
...
# https://medium.com/cyberark-engineering/building-production-ready-ai-agents-with-langgraph-a-real-life-use-case-7bda34c7f4e4 (ALSO has github repo in the article)
#
#
import os
